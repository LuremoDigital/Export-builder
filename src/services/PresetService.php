            ...
            'orders' => [
                ...
                [
                    ...
                    'fields' => [
                        ...
                        ['path' => 'transactions.refund.success.paymentAmount', 'label' => 'Refund Amounts', 'settings' => ['separator' => ' | ', 'decimalPlaces' => 2]],
                        ['path' => 'transactions.refund.success.dateCreated', 'label' => 'Refund Dates', 'settings' => ['separator' => ' | ']],
                        ['path' => 'transactions.refund.success.reference', 'label' => 'Refund References', 'settings' => ['separator' => ' | ']],
                        ['path' => 'transactions.refund.success.paymentCurrency', 'label' => 'Refund Currency', 'settings' => ['separator' => ' | ']],
